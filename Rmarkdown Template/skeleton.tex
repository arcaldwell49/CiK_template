...
\hypersetup{
  pdftitle={Some Title},
  pdfauthor={Some Name1, Same Name1, \& Another Nombre2},
  pdflang={en-EN},
  pdfsubject={Another Science},
...
\title{Some Title}
\author{Some Name\textsuperscript{1}, Same Name\textsuperscript{1}, \& Another Nombre\textsuperscript{2}}
\date{2022-08-01}
...
You can give Superscript\textsuperscript{1} or Subscript\textsubscript{2}
...
Fortunately the math formulas do not differ too much for HTML and PDF documents. For inline math a single \texttt{\$} is necessary while \texttt{\$\$} creates formula on its own line.
...
Somebody, A. M., \& Person, K. (2015). An Article. \emph{Journal Title}, \emph{1:2}, 10--12. \url{https://doi.org/10.XXXX/XXXXXXX}
